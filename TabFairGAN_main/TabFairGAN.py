...
class TabFairGAN():
    def __init__(self,
        ...
        self.protected_attribute = protected_attributes[0]

        self.target_class = target
        self.target_class_desired = target_class_desired
    ...
    def fit(self, df, epochs=200, batch_size=256, fair_epochs=30, lamda=0.5):
        ...
        protected_value_counts = df[self.protected_attribute].value_counts()

        # Find the value with the minimum count
        self.protected_attribute_under_represented = protected_value_counts.idxmin()
